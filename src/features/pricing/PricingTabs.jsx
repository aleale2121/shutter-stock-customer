export default function PricingTabs() {
  return (
    <div className="container w-3/4 mb-4 mx-auto -mt-6 border-gray-20">
      <ul
        className="flex flex-row items-center justify-center md:mx-auto -mb-px text-sm font-medium text-center"
        id="default-tab"
        data-tabs-toggle="#default-tab-content"
        role="tablist"
        data-tabs-active-classes="bg-slate-700 text-white border-4 border-violet-700"
        data-tabs-inactive-classes="border-2 bg-white border-gray-20"
      >
